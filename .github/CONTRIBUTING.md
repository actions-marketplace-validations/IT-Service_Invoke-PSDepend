...
[issue form](https://github.com/IT-Service/Invoke-PSDepend/issues/new/choose).

#### Solve an issue

Scan through our [existing issues](https://github.com/IT-Service/Invoke-PSDepend/issues)
